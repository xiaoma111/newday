...
def ajax4get(request):
    ...
    print('ajax请求正常chuli')
    neirong = uname['con']
    ko.shiyanfankui = uname['select']
    ko.isqiandao=False
    ko.shiyanneirong=neirong
    ko.kaishishijian = uname['startt']
    ko.jieshushijian = uname['endt']
    print("qweqwrqwetwertrtutryityidsfgdsfg",ko.jieshushijian)
