...
from .models import student,teacher,yuyue,guanliyuan
...
def indextest(req):
    ...
    guanliyuanname="    "
    guanliyuanphone="        "
    curguanliyuan=guanliyuan.objects.filter(ischoose=True)
    if(len(curguanliyuan)!=0):
        guanliyuanname=curguanliyuan[0].gname
        guanliyuanphone=curguanliyuan[0].gphone


    return render(req,'indextest.html',{'ep':elist,'equip':fl,'stu':stu,'kk':kk,'guanliyuanname':guanliyuanname,'guanliyuanphone':guanliyuanphone})
...
def baseinfo(request):
    ...
    if (len(curguanliyuan) != 0):
        guanliyuanname = curguanliyuan[0].gname
        guanliyuanphone = curguanliyuan[0].gphone
    return render(request,'baseinfo.html',{'stu':stu[0],'quanxian':st,'guanliyuanname':guanliyuanname,'guanliyuanphone':guanliyuanphone})
...
def myappointment(request):
    ...
    if (len(curguanliyuan) != 0):
        guanliyuanname = curguanliyuan[0].gname
        guanliyuanphone = curguanliyuan[0].gphone
    return render(request, 'myappointment.html', {'ep1': yuyuel, 'ep2': lishil, 'stu': stu,'guanliyuanname':guanliyuanname,'guanliyuanphone':guanliyuanphone})
...
def epappoint(request):
    ...
    if (len(curguanliyuan) != 0):
        guanliyuanname = curguanliyuan[0].gname
        guanliyuanphone = curguanliyuan[0].gphone
    return render(request,'epappoit.html',{'equip':eqlist,'stu':stu,'guanliyuanname':guanliyuanname,'guanliyuanphone':guanliyuanphone})
...
def appoint(request,num1):
    ...
    return render(request,'appoint.html',{'t':stimelist,'s':rangelist,'date1':datelist,'epq':ep,'yueli1':chuandi[6],
                                          ...
                                          'eid':num1,'username':name,'stu':stu,'guanliyuanname':guanliyuanname,'guanliyuanphone':guanliyuanphone})
@checklogin
