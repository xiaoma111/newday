...
class equipmentAdmin(admin.ModelAdmin):
    ...
    list_display = [eid1,ename1,eshiyanshi1,eguanliyuan1,ezhuangtai1]
...
class yuyueAdmin(admin.ModelAdmin):
    ...
    def shiyanneirong1(self):
        return self.shiyanneirong
    shiyanneirong1.short_description='实验内容'
    ...
    def isquxiao1(self):
        if (self.isquxiao):
            ...
            return "否"
    isquxiao1.short_description="已取消"
    ...
    list_display = [ysid1, yeid1, ydate1,ytimestart1,shichang1,shiyanneirong1,shiyanfankui1,isquxiao1,isqiandao1]
    list_filter = ['ysid','yeid','ydate','isquxiao','isqiandao']
    search_fields = ['ysid__sname','yeid__ename','ydate','isquxiao','isqiandao']
...
class guanliyuanAdmin(admin.ModelAdmin):
    def gname1(self):
        return self.gname
    gname1.short_description = '姓名'

    def gphone1(self):
        return self.gphone
    gphone1.short_description = '联系方式'
    ...
    def ischoose1(self):
        if(self.ischoose):
            ...
            return "否"
    ischoose1.short_description = '选中'
    list_display = [gname1, gphone1,ischoose1]
    # def get_model_perms(self, request):
    #     return {
    #         # 'add': self.has_add_permission(request),
    #         'change': self.has_change_permission(request),
...
admin.site.register(models.guanliyuan, guanliyuanAdmin)
